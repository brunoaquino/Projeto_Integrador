...
public class NumeroExtensoUtil {
	...
	private boolean ehPrimeiroGrupoUm() {
		return (((Integer) nro.get(nro.size() - 1)).intValue() == 1) ? true
				: false;
	}
	...
	public static void main(String[] args) {
		NumeroExtensoUtil teste = new NumeroExtensoUtil(new BigDecimal(
				11234.123));
		System.out.println("Numero  : "
				+ (new DecimalFormat().format(Double.valueOf("234.12"))));
